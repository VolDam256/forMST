...
picture__slaider[5].classList.remove("picture__slaider--active");
picture__slaider[5].classList.add("picture__slaider--active");

console.log(description__semitext[0].textContent.length);
...
function listremove(string, nomer) {
  ...
  string.onclick = function () {
    if (nomer != whataname) {
      ...
      picture__slaider[5 - nomer].classList.remove("picture__slaider");
